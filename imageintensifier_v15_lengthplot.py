...
if __name__ == '__main__':
    ...
    reader = tifffile.imread("metignen13-05-2025/testvncent67mbarVO2025-05-13_14-56-59/testvncent67mbarVO2025-05-13_14-56-59.ome.tif")
    ...
    s.kill()
    stop = time.time()
    print(f"The program took {stop-start} seconds to excecute")
